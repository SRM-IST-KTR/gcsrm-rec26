const StepCard = ({
  ...
  <div className={`flex flex-col gap-5 items-start w-full h-full ${className}`}>
    ...
    <div className="flex flex-col gap-3 items-start self-stretch min-h-[150px] bg-white rounded-[20px] border-[3px] border-[#1e1b24] shadow-[4px_4px_0px_0px_rgb(30_27_36)] p-6 flex-1">
      <p className="text-xl font-black text-left text-[#1e1b24] self-stretch h-fit">{title}</p>
      <p className="text-sm font-rubik font-medium text-left text-[#5c5866] leading-normal self-stretch flex-1">
        {description}
      </p>
    </div>
  </div>
